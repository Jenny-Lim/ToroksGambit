...
public class Pawn : Piece
{
    ...
    public override void UpdateMoves()
    {
        ...
        //if (InBoundsCheck(pieceX, pieceY + dir) && ClearCheck(pieceX, pieceY, pieceX, pieceY + dir)) // can just check if the spot is null instead
        //{
        //clearResult = ClearCheck(pieceX, pieceY + dir);
        ...
        //if (InBoundsCheck(pieceX + dir, pieceY + dir) && pieceBoard[pieceX + dir, pieceY + dir] != null && !pieceBoard[pieceX + dir, pieceY + dir].GetComponent<Piece>().isTorok) // if can capture another piece
        //{
        ...
        //        if (clearResult == 0 && pieceBoard[pieceX + dir, pieceY + dir] != null) {
