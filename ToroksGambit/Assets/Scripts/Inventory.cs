...
public class Inventory : MonoBehaviour
{
    ...
    [SerializeField] private int[] maxHeldPieces = {50,50,50,50,10};//the maximum number of each piece the player can have
    private int[] heldPieces = {20,20,20,20,10};//the amount of each piece the player has
